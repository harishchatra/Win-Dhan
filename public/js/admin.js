  ...
  invoiceWindow.document.write(`
    <html>
      <head>
        ...
        <style>
          body { font-family: 'Outfit', sans-serif; padding: 40px; color: #112a18; }
          .header { display: flex; justify-content: space-between; border-bottom: 2px solid #B87333; padding-bottom: 20px; }
          .logo { font-size: 24px; font-weight: 800; color: #B87333; }
...
>
 ...
 DHAN ENTERPRISE</div>
        ...
        <div class="totals">
          ...
          <div style="font-size: 20px; font-weight: 800; color: #B87333;">Total Amount Paid: ₹${p.paid.toLocaleString('en-IN')}</div>
...
function applyRolePermissions() {
  const allNavs = [
    ...
    { id: 'nav-btn-stalls', roles: ['super_admin', 'event_director', 'sales_manager', 'sales_executive'] },
    { id: 'nav-btn-map', roles: ['super_admin', 'event_director', 'sales_manager', 'sales_executive'] },
    ...
    { id: 'nav-btn-media', roles: ['super_admin', 'event_director'] },
    { id: 'nav-btn-tasks', roles: ['super_admin', 'event_director', 'sales_manager', 'sales_executive', 'sponsor_manager'] },
    { id: 'nav-btn-reports', roles: ['super_admin', 'event_director', 'finance_manager', 'sales_manager'] },
    { id: 'nav-btn-settings', roles: ['super_admin', 'event_director'] },
...
function printCertificateElement() {
  ...
  const style = `
    body { font-family: Georgia, serif; text-align: center; padding: 50px; color: #112a18; border: 15px double #B87333; }
    h1 { font-size: 32px; color: #B87333; letter-spacing: 2px; }
  `;
